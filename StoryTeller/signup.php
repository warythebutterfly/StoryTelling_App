        ...
        <div class="row align-items-center py-5">
          ...
          <div class="col-lg-5 px-lg-4">
            ...
            <form id="signUpForm" class="mt-4" method="POST">
              ...
              <div class="form-group mb-4">
                <input type="password" id="confirmpassword" name="password" placeholder="Confirm Password" class="form-control border-0 shadow form-control-lg text-violet" required>
              </div>
              <div class="custom-control custom-checkbox">
                <input id="customCheck1" type="checkbox" checked class="custom-control-input">
                <input type="hidden" name="isStorySeeker" value="0" class="form-control">
              ...
              <br>
              <br>
              <small>Already have an account? <a href="st_signin.html">Sign in</a></small>
            </form>
          </div>
        </div>
