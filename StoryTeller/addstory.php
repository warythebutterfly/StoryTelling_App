      ...
      <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow"><a href="#" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead" ><i class="fas fa-align-left"></i></a><a href="index.html" class="navbar-brand font-weight-bold text-uppercase text-base">Story Telling App</a>
        <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
          ...
          <li class="nav-item dropdown ml-auto"><a id="userInfo" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><img src="../img/avatar-6.jpg" alt="Jason Doe" style="max-width: 2.5rem;" class="img-fluid rounded-circle shadow"></a>
            <div aria-labelledby="userInfo" class="dropdown-menu"><a href="#" class="dropdown-item"><strong class="d-block text-uppercase headings-font-family">Mark Stephen</strong><small>Story Teller</small></a>
      ...
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            <!-- GET APPROPRIATE ICONS -->
              ...
              <li class="sidebar-list-item"><a href="addstory.php" class="sidebar-link text-muted active"><i class="o-sales-up-1 mr-3 text-gray"></i><span>Add Story</span></a></li>
              <li class="sidebar-list-item"><a href="stories.html" class="sidebar-link text-muted"><i class="o-table-content-1 mr-3 text-gray"></i><span>My Stories</span></a></li>
              <li class="sidebar-list-item"><a href="storyseeker/index.html" class="sidebar-link text-muted"><i class="o-survey-1 mr-3 text-gray"></i><span>Seek Stories</span></a></li>
            ...
            <div class="row">
              ...
              <div class="autocomplete-container" id="autocomplete-container" > </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <!-- <input type="file" id="img" name="photo" accept="image/*" class="form-control"> -->
                      ...
                      <div class="form-group row">
                        ...
                        <input type="hidden" name="isApproved" value="1" class="form-control">
                      </div>
                      <div class="line"></div>
                ...
                <div class="modal-body">
                  ...
                  <form>
                    <div class="form-group">
                        ...
                        <input type="file" id="img" name="photo" accept="image/*" class="form-control" name="file">
                      </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">       
                      <input type="submit" id="btneditprofile" value="Update" class="btn btn-primary" name="update">
                    </div>
                  </form>
                </div>
                  ...
                  <form>
                    ...
                    <div class="form-group">       
                      ...
                      <div class="form-group">       
                        ...
                        <input type="password" placeholder="Confirm New Password" id="confirnnewpassword" class="form-control">
                      </div>
                    <div class="form-group">       
